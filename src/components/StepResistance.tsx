...
const StepResistance: React.FC<Props> = ({ initialValue, onNext, onBack }) => {
    ...
    return (
        <div className="animate-fade-in">
            <h2 className="text-2xl font-bold mb-4">Step 2: The Cockroach 🪳</h2>
            <p className="mb-6 opacity-90">
                Ask yourself: <strong>"IF I do this, THEN... what bad thing will happen?"</strong>
                <br />
                <span className="text-sm opacity-75">Write down the negative effect or fear.</span>
            </p>
            <form onSubmit={handleSubmit}>
                <textarea
                    ...
                    placeholder="e.g., ...then I will be too tired to work."
                    value={value}
